...
export function internalMint({
    ...
    assert(!contract.tokensById.containsKey(tokenId), "Token already exists");  // kiem tra tokenid neu co yhi bao loi ...

    // Insert token
    contract.tokensById.set(tokenId, token); // ghi de data token tren key
