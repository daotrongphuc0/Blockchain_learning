...
let HelloNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = call({
  ...
  //  chi danh cho nha paat trien(CONTRACT_NAME=dev-1668250225252-43879930462935)
  set_greating_private({
    message
  }) {
    this.greeting = message;
    log(predecessorAccountId() + "called private function");
  }
  // cac ham lien quan den giao dich
  set_greating_payable({
    message
  }) {
    // lay so du 
    let depositeAmount = attachedDeposit(); // tra ve doctor near = 10^24 near
    // lay danh sach ac dang ki fn
    let predeccesorId = predecessorAccountId();
    signerAccountId();
    log(predeccesorId + "deposit " + depositeAmount);
    this.greeting = message;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greating_private", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greating_private"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greating_payable", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greating_payable"), _class2.prototype)), _class2)) || _class);
function set_greating_payable() {
  ...
  const _result = _contract.set_greating_payable(_args);
...
function set_greating_private() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.set_greating_private(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
export { get_greeting, set_greating_payable, set_greating_private, set_greeting };
